...
feature "User interacts with advanced search", :elasticsearch do
  ...
  background do
    ...
    Fabricate(:review, video: star_wars_1, stars: 5, content: "awesome movie!!!")
    Fabricate(:review, video: star_wars_2, stars: 3)
    Fabricate(:review, video: star_trek,  stars: 4, user: dan)
    Fabricate(:review, video: star_trek,  stars: 5, user: katie)
    refresh_index
    sign_in
